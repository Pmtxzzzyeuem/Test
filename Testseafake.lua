local SeaUii = loadstring(game:HttpGet("https://raw.githubusercontent.com/SeaBabyBF/SeaGateOpenSource-/main/SeaGateUii.lua"))()
    ...
    elseif World3 then
     ...
     elseif MyLevel == 2500 or MyLevel <= 2524 then
        ...
        elseif MyLevel == 2525 or MyLevel <= 2550 then
            ...
            CFrameMon = {CFrame.new(-16618.7422, 54.6350365, 1099.51611, -0.907711327, 0, 0.419595182, 0, 1, 0, -0.419595182, 0, -0.907711327), CFrame.new(-16735.6797, 20.5312595, 1110.57861, 0.864618421, 0, 0.502429128, 0, 1, 0, -0.502429128, 0, 0.864618421), CFrame.new(-16787.3203, 20.6406345, 992.125488, -0.775471091, 0, 0.631383121, 0, 1, 0, -0.631383121, 0, -0.775471091), CFrame.new(-16940.8047, 10.5312548, 1070.85986, 0.545324266, 0, -0.838225186, 0, 1, 0, 0.838225186, 0, 0.545324266), CFrame.new(-16901.2266, 10.5312548, 969.969238, -0.838247061, 0, -0.545290649, 0, 1, 0, 0.545290649, 0, -0.838247061)}
        end
    end
end
...
local Library = Update:Window("SeaGate Hub II [70%]","");
local H = Library:AddTab("Info","12950870585")
local Main = Library:AddTab("General","6026568198")
local Sub = Library:AddTab("Sub Farming","9606626859")
local N = Library:AddTab("Settings","10734950309")
local Sea = Library:AddTab("Local Sea Event","10709761530")
local RaceV4 = Library:AddTab("Race","10747372167")
...
local S = Library:AddTab("Shop","10734952479")
...
H:AddLine()
H:AddLabel("SeaGate Hub")

H:AddSeperator("Credits")

H:AddLabel("Script Made By ThanhDuyy")
...
H:AddSeperator("Server")
   
osfunc = H:AddLabel("Executer Time")
    ...
    local function UpdateOS()
        ...
        osfunc:Set("OS >" .. datetime.." - "..timezone.." [" .. code .. "]")
        end
        spawn(function()
         while true do
         UpdateOS()
...
spawn(function()
  ...
  pcall(function()
    ...
    QuestStatus:Set("[Quest] : "..NameQuest.." | [Level] : "..LevelQuest)
        ...
        Main:AddToggle("Start Auto Farm",_G.AutoFarm, function(value)
            _G.AutoFarm = value
...
local BoSs = Main:AddLabel("Status : Select Boss")
    ...
    Main:AddToggle("Auto Farm All Boss",_G.AutoFarmAllBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
Main:AddToggle("Auto Farm Chest [ Tween ]",_G.AutoFarmChest,function(value)
...
Main:AddToggle("Auto Farm Chest [ Bypass ]",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:AddToggle("Auto Stop Items [God's Chalice / Fist of Darkness ]",_G.StopItemsChest,function(vu)
...
spawn(function()
    while wait() do
        ...
        PosY = 35
    N:AddSlider("Farm Distance",0,50,PosY,function(value)
    PosY = value
    end)

    TweenSpeed = 150
    N:AddSlider("Player Tween Speed",0,350,TweenSpeed,function(value)
        TweenSpeed = value
    end)

    N:AddToggle("Bring Mob",true,function(Mag)
        _G.BringMonster = Mag
    end)
        ...
        while task.wait() do
            pcall(function()
                if _G.BringMonster then
                    CheckQuest()
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if _G.AutoFarm and _G.Auto_Bone and StartBring  and v.Name == Mon and (Mon == "Factory Staff [Lv. 800]" or Mon == "Monkey [Lv. 14]" or Mon == "Dragon Crew Warrior [Lv. 1575]" or Mon == "Dragon Crew Archer [Lv. 1600]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            ...
                            sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                        elseif _G.AutoFarm and _G.Auto_Bone and StartBring and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.HumanoidRootPart.CFrame = PosMon
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
    ...
    _G.BringMode = "Normal"
    N:AddDropdown("BringMob Mode", Bring,function(value)
        _G.BringMode = value
    end)
    spawn(function()
        while wait(.1) do
    ...
    N:AddToggle("Fast Attack",true,function(value)
        _G.FastAttack = value
    end)   

    N:AddToggle("Attack Aura",true,function(value)
        _G.AttackMob = value
    end)
...
N:AddDropdown("Fast Attack Delay", AttackList,function(v)
    _G.FastAttackDelay = v
end)

N:AddSeperator("Other") 
   
    N:AddToggle("Bypass Tp",false,function(Fast)
    BypassTP = Fast
    end)

    N:AddToggle("Auto Set Spawn Point",true,function(value)
    _G.Set = value
    end)
...
N:AddToggle("Auto Haki",false,function(value)
_G.AutoHaki = value
end)
spawn(function()
    while wait(.1) do
...
N:AddToggle("Remove Effects",true,function(value)
    ...
    spawn(function()
        ...
        N:AddToggle("Remove Damage",false, function()
        ...
        N:AddToggle("Remove Notifications Text",false,function(NamfonGay)
            ...
            N:AddToggle("Remove Hit Sound And Level Up",false,function(Remo)
                _G.RemoveHit = Remo
                end)
                ...
                N:AddToggle("Black Screen",false,function(Umm)
                    ...
                    spawn(function()
                        ...
                        spawn(function()
                          ...
                          if _G.WhiteScreen then
                            ...
                            N:AddToggle("White Screen",_G.WhiteScreen,function(value)
...
N:AddToggle("Bypass Anti Cheat", true,function(x)
_G.ResetFlags = x
end)
...
Sub:AddSeperator("Bone Farm")

local ListB = {"No Quest", "Quest", "MasteryFruit"}
    BoneFMode = "No Quest"

    Sub:AddDropdown("Select Mode",ListB,function(value)
        BoneFMode = value
    end)

    BoneCheck = Sub:AddLabel("Your Bone :")
    ...
    local BoneFarm = Sub:AddToggle("Auto Farm Bone",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
        ...
        Sub:AddToggle("Auto Random Surprise",_G.Auto_Random_Bone,function(value)
        ...
        Sub:AddToggle("Auto Pray",pry,function(value)
            _G.Pray = value
                StopTween(_G.Pray)
            end)
            ...
            Sub:AddToggle("Auto Try Luck",Trylux,function(value)
                _G.Trylux = value
                StopTween( _G.Trylux)
                end)
                spawn(function()
                ...
                Sub:AddSeperator("Cake Farm")

    
        local MobKilled = Sub:AddLabel("Killed")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                ...
                Sub:AddToggle("Auto Farm Cake Prince",_G.AutoDoughtBoss,function(value)
    ...
    Sub:AddToggle("Auto Spawn Cake Prince",_G.AutoSpawnCP,function(value)
        ...
        spawn(function() 
            ...
            Sub:AddToggle("Auto Kill Cake Prince", _G.AutoCakePrince,function(value)
        ...
        Sub:AddToggle("Auto Kill Dough King", _G.Autodoughking,function(value)
    ...
    Sub:AddSeperator("Elite Hunter")

    local Elite_Hunter_Status = Sub:AddLabel("Status")
	spawn(function()
		while wait() do
			pcall(function()
    ...
    local Elite_Hunter_Progress = Sub:AddLabel("Progress :")
    spawn(function()
		while wait() do
			pcall(function()
					Elite_Hunter_Progress:Set("Progress : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))	
            end)
        end
			end)

    Sub:AddToggle("Auto Elite Hunter",_G.AutoElitehunter,function(value)
    ...
    Sub:AddToggle("Auto Rengoku",_G.AutoRengoku,function(value)
        _G.AutoRengoku = value
        StopTween(_G.AutoRengoku) 
    end)
    
    Sub:AddToggle("Auto Hallow Scythe",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)

    Sub:AddToggle("Auto Get Tushita", _G.Autotushita,function(value)
   ...
   spawn(function()
    ...
    Sub:AddToggle("Auto Get Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    end)
    ...
    Sub:AddToggle("Auto Cursed Dual Katana",_G.AutoCdk,function(value)
    ...
    Sea:AddSeperator("Mirage Island")
    Mirragecheck = Sea:AddLabel("Mirage Island")
    Sea:AddToggle("Teleport To Mirage Island",_G.AutoMysticIsland,function(value)
        ...
        StopTween(_G.AutoMysticIsland)
            ...
            Sea:AddToggle("Teleport Advanced Fruit Dealer",_G.TPNPC,function(value)
                _G.Miragenpc = value
                StopTween(_G.Miragenpc)
            end)
    
            Sea:AddSeperator("Kitsune Island")
            Kitsunecheck = Sea:AddLabel("Kitsune Island") 
            Sea:AddToggle("Teleport To Kitsune Island",_G.TeleportKitsune,function(value)
            ...
            Sea:AddToggle("Auto Collect Azure",_G.CollectAzure,function(value)
            ...
            Sea:AddSlider("Set Azure Ember", 10, 25, _G.SetToTradeAureEmber, function(v)
                _G.SetToTradeAureEmber = v
            end)
    
            Sea:AddToggle("Auto Trade Azure Ember", false,function(state)
    ...
    Sea:AddDropdown("Select Boat", ListSeaBoat, function(x)
    _G.SelectedBoat = x
    end)

    _G.SelectedZone = "Zone 5"
    Sea:AddDropdown("Select Zone", ListSeaZone, function(x)
    _G.SelectedZone = x
    end)

    BoatSpeed = 300
    Sea:AddSlider("Boat Tween Speed", 100, 350, BoatSpeed, function(v)
        BoatSpeed = v
    end)
    ...
    Sea:AddToggle("Auto Sail Boat", _G.SailBoat, function(state)
        _G.SailBoat = state
...
function AddEsp(Name, Parent)
    ...
    Sea:AddToggle("Auto Farm Shark", _G.AutoKillShark, function(value)
    ...
    Sea:AddToggle("Auto Farm Piranha", _G.AutoKillPiranha,  function(value)
    ...
    Sea:AddToggle("Auto Farm Fish Crew", _G.AutoKillFishCrew, function(value)
    ...
    Sea:AddToggle("Auto Kill Ghost Ship", _G.RelzFishBoat, function(value)
        ...
        Sea:AddToggle("Auto Kill Terrorshark", _G.AutoTerrorshark,function(value)
     ...
     spawn(function()
        ...
        Sea:AddToggle('Auto Kill Seabest', false, function(value)
        ...
        function CheckSeaBeast()
            ...
            return false
             ...
             spawn(function()
                ...
                Sea:AddSeperator("Ability")
                local BrightValue = 20
                Sea:AddSlider("Brightness",1,100,BrightValue,function(value)
                    BrightValue = value
                end)
            
                Sea:AddButton("Set Bright", function()
                    game:GetService("Lighting").Brightness = BrightValue
                end)
            
                Sea:AddToggle("Speed Boat", false,false,function(value)
                ...
                Sea:AddToggle("No Clip Rock", false,function(state)
                    _G.NoClipRock = state
                    end)
                ...
                Sea:AddToggle("Auto Press W", _G.AutoPressW,function(state)
                _G.AutoPressW = state 
                end)
                spawn(function()
                    while wait() do
        ...
        Sea:AddSeperator("Settings")
    
        Sea:AddToggle("Use Skill Devil Fruit", true, function(value)
            _G.UseSeaFruitSkill = value
        end)
        Sea:AddToggle("Use Skill Melee", true,  function(value)
            _G.UseSeaMeleeSkill = value
        end)
        Sea:AddToggle("Use Skill Sword", true,  function(value)
            _G.UseSeaSwordSkill = value
        end)
        Sea:AddToggle("Use Skill Gun", true,  function(value)
            _G.UseSeaGunSkill = value
        end)
    
        Sea:AddLabel("[ Skill Fruit ]")
        Sea:AddToggle("Skill Z", true,  function(value)
        _G.SkillFruitZ = value
        end)
        Sea:AddToggle("Skill X", true,  function(value)
        _G.SkillFruitX = value
        end)
        Sea:AddToggle("Skill C", true, function(value)
        _G.SkillFruitC = value
        end)
        Sea:AddToggle("Skill V", false,  function(value)
        _G.SkillFruitV = value
        end)
        Sea:AddToggle("Skill F", _G.SkillFruitF,  function(value)
        _G.SkillFruitF = value
        end)
    
        Sea:AddLabel("[ Skill Melee ]")
        Sea:AddToggle("Skill Z", true, function(value)
        ...
        Sea:AddToggle("Skill V", _G.SkillMeleeV,  function(value)
        _G.SkillMeleeV = value
        end)
    
        Sea:AddLabel("[ Skill Sword & Gun ]")
        Sea:AddToggle("Skill Z", true, function(value)
    ...
    RaceV4:AddSeperator("Race V2")

    RaceV4:AddToggle("Auto Evo Race [ V2 ]",_G.Auto_EvoRace,function(value)
...
RaceV4:AddToggle("Teleport To Mirage Island",_G.AutoMysticIsland,function(value)
    _G.AutoMysticIsland = value
    StopTween(_G.AutoMysticIsland)
end)

RaceV4:AddToggle("Tween Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
RaceV4:AddToggle("Auto Active Race V3",_G.AutoAgility,function(value)
...
RaceV4:AddToggle("Auto Ancient One Quest",_G.AutoRace,function(value)
 _G.AutoRace = value
 StardFarm = value
...
RaceV4:AddToggle("Disabled Inf Stairs", nil,false, function(value)
  ...
  RaceV4:AddButton("Teleport Fish Door",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("Teleport Ghoul Door",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("Teleport Human Door",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("Teleport Mink Door",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("Teleport Sky Door",function()
  ...
  RaceV4:AddToggle("Auto Kill Player in Trail",false,function(Val)
  _G.AutoKillTial = Val
...
spawn(function()
 ...
 RaceV4:AddButton("Auto Complete Angel Trial",function(t)
    ...
    local Island = R:AddLabel("Start Dungeon")
...
spawn(function()
    ...
    R:AddLabel("[ Automatic ]")
    R:AddToggle("Start Raid",_G.Auto_StartRaid,function(value)
    ...
    R:AddToggle("Auto Start Raid", _G.Auto_StartRaid,function(x)
        _G.Auto_StartRaid = x
    end)
    R:AddToggle("Kill Aura", _G.Kill_Aura,  function(x)
        _G.Kill_Aura = x
    end)
    R:AddToggle("Auto Buy Chip", _G.AutoBuyChip, function(x)
        _G.AutoBuyChip = x
    end)
    R:AddToggle("Auto Next Island", _G.Auto_Dungeon,function(x)
        _G.Auto_Dungeon = x
        StopTween(_G.Auto_Dungeon)
    end)
    R:AddToggle("Auto Awaken",false,function(value)
        _G.Awaken = value
    end)
    ...
    R:AddSlider("Set Price Devil Fruit", 0, 10000000,_G.UnstoreFruitPrice, function(v)
    _G.UnstoreFruitPrice = v
    end)

    R:AddToggle("Auto Unstore Fruit",false,function(value)
    ...
    R:AddSeperator("Law Raid")

    R:AddToggle("Auto Raid Law", _G.autoLawRaid, function(state)
...
P:AddSeperator("Combat")
    ...
    P:AddToggle("Teleport To Player",false,function(value)
...
spawn(function()
    ...
    T:AddButton("Teleport To First Sea",function()
    ...
    if World1 then
        T:AddTextboxDropdown("Select NPC",{
            "Random Devil Fruit",
            "Blox Fruits Dealer",
            "Remove Devil Fruit",
            "Ability Teacher",
    ...
    T:AddButton("Rejoin Server",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    T:AddButton("Server Hop",function()
        while wait() do
            local module = loadstring(game:HttpGet"https://raw.githubusercontent.com/FlazhGG/Hubs/main/ServerHop")()
    ...
    JobAiDee = T:AddLabel("Server Job ID : ")
    
    T:AddButton("Copy Server Job ID",function()
	setclipboard(tostring(game.JobId))
	end)
	
    T:AddTextbox("Enter Server Job ID", true, function(value)
	_G.Job = value
	end)
    ...
    S:AddSeperator("Legendary Sword")

    S:AddToggle("Auto Buy Legendary Sword",_G.AutoBuyLegendarySword,function(value)
    ...
    S:AddSeperator("Haki Color")

    S:AddToggle("Auto Buy Haki Color",_G.AutoBuyEnchancementColour,function(value)
    ...
    S:AddButton("Buy Geppo [ $10,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
    S:AddButton("Buy Buso Haki [ $25,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
    S:AddButton("Buy Soru [ $25,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    S:AddButton("Buy Observation Haki [ $750,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
...
S:AddButton("Buy Boat",function()
    ...
    S:AddButton("Buy Black Leg [ $150,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    
    S:AddButton("Buy Electro [ $550,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    end)
    
    S:AddButton("Buy Water Kung Fu [ $750,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    
    S:AddButton("Buy Dragon Claw [ ฦ’1,500 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    
    S:AddButton("Buy Superhuman [ $3,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end)
    
    S:AddButton("Buy Death Step [ ฦ’5,000 $5,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    S:AddButton("Buy Sharkman Karate [ ฦ’5,000 $2,500,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    S:AddButton("Buy Electric Claw [ ฦ’5,000 $3,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    S:AddButton("Buy Dragon Talon [ ฦ’5,000 $3,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

    S:AddButton("Buy God Human [ ฦ’5,000 $5,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)

    S:AddButton("Buy Sanguine Art [ ฦ’5,000 $5,000,000 ]",function()
    ...
    S:AddButton("Cutlass [ $1,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
    end)

    S:AddButton("Katana [ $1,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
    end)
    
    S:AddButton("Iron Mace [ $25,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
    end)
    
    S:AddButton("Dual Katana [ $12,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
    end)
    
    S:AddButton("Triple Katana [ $60,000 ]", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
    end)
    
    S:AddButton("Pipe [ $100,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
    end)
    
    S:AddButton("Dual-Headed Blade [ $400,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
    end)
    
    S:AddButton("Bisento [ $1,200,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
    end)
    
    S:AddButton("Soul Cane [ $750,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
    end)

    S:AddButton("Pole v.2 [ ฦ’5,000 ]",function()
		game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk")
	end)

    S:AddSeperator("Gun")
    
    S:AddButton("Slingshot [ $5,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
    end)
    
    S:AddButton("Musket [ $8,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
    end)
    
    S:AddButton("Flintlock [ $10,500 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
    end)
    
    S:AddButton("Refined Slingshot [ $30,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
    end)
    
    S:AddButton("Refined Flintlock [ $65,000 ]",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Refined Flintlock"
		}
    ...
    S:AddButton("Cannon [ $100,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
    end)
    
    S:AddButton("Kabucha [ ฦ’1,500]",function()
...
S:AddButton("Reset Stats [ Use ฦ’2,500 ]", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:AddButton("Random Race [ Use ฦ’3000 ]", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)
    --------------Accessories-----------------
    S:AddSeperator("Accessories")
	S:AddButton("Black Cape [ $50,000 ]",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Black Cape"
		}
	...
	S:AddButton("Swordsman Hat [ $150,000 ]",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Swordsman Hat"
		}
	...
	S:AddButton("Tomoe Ring [ $500,000 ]",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Tomoe Ring"
		}
...
D:AddSeperator("Fruits")
    ...
    D:AddDropdown("Store Rarity Fruits", SelectRarityFruits, SetRarityFruits, function(x)
        SetRarityFruits = x      
    end)
    ...
    D:AddToggle("Teleport To Fruit",_G.Grabfruit,function(value)
    _G.Grabfruit = value
    end)
        spawn(function()
			while wait(.1) do
    ...
    D:AddButton("Grab All Fruits", function()
        for i,v in pairs(game.Workspace:GetChildren()) do
            if v:IsA("Tool") then
...
Misc:AddSeperator("ESP")
    ...
    Misc:AddToggle("ESP Real Fruit",false,function(a)
        RealFruitESP = a
...
Misc:AddToggle("Esp Mirage Island", false,function(value)
...
Misc:AddToggle("Esp Gear", false, function(value)
    ...
    Misc:AddToggle("Auto Active Race V3",_G.AutoAgility,function(value)
        _G.AutoAgility = value
    end)

    Misc:AddToggle("Auto Active Race V4",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("Infinite Ability",false,false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
...
PointStats = 1
Ss:AddSlider("Point",1,100,PointStats,function(value)
PointStats = value
end)
...
local Fruit = Ss:AddLabel("Fruit : ")
    ...
    game.StarterGui:SetCore("SendNotification", {
        Icon = "http://www.roblox.com/asset/?id=17279157055";
        Title = "SeaGate Hub true2", 
